...
<div class="navbar navbar-inverse navbar-fixed-top" role="navigation"  style='background-color:#386DBD;'>
      ...
      <?php/*
        ...
        <ul class="nav navbar-nav">
          <li>
          <a href="http://www.cityplanner.it/valleolona" style="color: white;">
          <i class="fa fa-question-circle"></i>&nbsp;&nbsp;Portale: Valle Olona</a>
          </li>        
          <li>
          ...
          <i class="fa fa-question-circle"></i>&nbsp;&nbsp;Autore: City Planner</a>
          </li>
          <li>
          <a href="http://ecomuseo.comune.parabiago.mi.it/ecomuseo/mappareilparco/mulinimappata.htm" style="color: white;">
          <i class="fa fa-question-circle"></i>&nbsp;&nbsp;Credits: MAPPA Parco Mulini</a>
          </li>
          <?php/*
          <li class="dropdown">
...
var mapquestHYB = L.tileLayer("http://www.cityplanner.it/experiment_host/tile/tile_olona_parcomulini/tile_source/{z}/{x}/{y}.png" , {
            tms: true,
  maxZoom: 19,
  subdomains: ["otile1", "otile2", "otile3", "otile4"],
  attribution: 'Tiles courtesy of <a href="http://www.mapquest.com/" target="_blank">MapQuest</a> <img src="http://developer.mapquest.com/content/osm/mq_logo.png">. Map data (c) <a href="http://www.openstreetmap.org/" target="_blank">OpenStreetMap</a> contributors, CC-BY-SA.'
...
var mapquestOAM = L.layerGroup([L.tileLayer("http://{s}.mqcdn.com/tiles/1.0.0/sat/{z}/{x}/{y}.jpg", {
  maxZoom: 18,
  subdomains: ["oatile1", "oatile2", "oatile3", "oatile4"]
...
*/
$.getJSON("http://www.cityplanner.it/valleolona/geodata/bound_parcomulini.geojson", function (data) {
  museums.addData(data);
});
...
map = L.map("map", {
  ...
  layers: [mapquestOSM,  mapquestHYB, subwayLines, boroughs, markerClusters, highlight],
  zoomControl: false,
...
var groupedOverlays = {
  "Points of Interest": {
    ...
    "<img src='<?php echo $icon1;?>' width='24' height='28'>Mappa Paesaggio": mapquestHYB/*,
