...
echo"<h3>POI a $title</h3><p style='font-size:12px;'>";
$the_query = new WP_Query(array('meta_key' => 'nome_comune', 'meta_value' => ucwords(strtolower($title))));
$count_poi=0;
// Loop sulla query
...
// TITOLO
$title_poi=get_the_title();
$plink_poi=get_permalink();
$postid_poi = get_the_ID();
echo "<a href='$plink_poi'>$title_poi</a> ";
